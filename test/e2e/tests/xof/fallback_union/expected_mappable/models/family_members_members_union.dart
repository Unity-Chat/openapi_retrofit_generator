...
extension FamilyMembersMembersUnionDeserializer on FamilyMembersMembersUnion {
  static FamilyMembersMembersUnion tryDeserialize(
    ...
    return switch (value) {
      ...
      _ => FamilyMembersMembersUnionUnknownMapper.fromJson(json),
    };
  }
}
...
class FamilyMembersMembersUnionUnknown extends FamilyMembersMembersUnion
    with FamilyMembersMembersUnionUnknownMappable {
  final Map<String, dynamic> json;

  const FamilyMembersMembersUnionUnknown(this.json);

  static FamilyMembersMembersUnionUnknown fromJson(Map<String, dynamic> json) =>
      FamilyMembersMembersUnionUnknown(json);
}
