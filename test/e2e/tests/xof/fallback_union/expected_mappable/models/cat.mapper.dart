...
class CatMapper extends ClassMapperBase<Cat> {
  ...
  static CatTypeType _$type(Cat v) => v.type;
  static const Field<Cat, CatTypeType> _f$type = Field('type', _$type);
  ...
  static Cat _instantiate(DecodingData data) {
    return Cat(type: data.dec(_f$type), mewCount: data.dec(_f$mewCount));
  }
