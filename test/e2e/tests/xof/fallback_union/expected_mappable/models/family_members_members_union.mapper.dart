...
class FamilyMembersMembersUnionMapper
  ...
  static FamilyMembersMembersUnionMapper ensureInitialized() {
    if (_instance == null) {
      ...
      FamilyMembersMembersUnionUnknownMapper.ensureInitialized();
    }
    return _instance!;
  }
...
class FamilyMembersMembersUnionUnknownMapper
    extends SubClassMapperBase<FamilyMembersMembersUnionUnknown> {
  FamilyMembersMembersUnionUnknownMapper._();

  static FamilyMembersMembersUnionUnknownMapper? _instance;
  static FamilyMembersMembersUnionUnknownMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = FamilyMembersMembersUnionUnknownMapper._(),
      );
      FamilyMembersMembersUnionMapper.ensureInitialized().addSubMapper(
        _instance!,
      );
  ...
  @override
  final String id = 'FamilyMembersMembersUnionUnknown';

  static Map<String, dynamic> _$json(FamilyMembersMembersUnionUnknown v) =>
      v.json;
  static const Field<FamilyMembersMembersUnionUnknown, Map<String, dynamic>>
  _f$json = Field('json', _$json);

  @override
  final MappableFields<FamilyMembersMembersUnionUnknown> fields = const {
    #json: _f$json,
  };
  ...
  static FamilyMembersMembersUnionUnknown _instantiate(DecodingData data) {
    return FamilyMembersMembersUnionUnknown(data.dec(_f$json));
  }

  @override
  final Function instantiate = _instantiate;

  static FamilyMembersMembersUnionUnknown fromJson(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<FamilyMembersMembersUnionUnknown>(map);
  }

  static FamilyMembersMembersUnionUnknown fromJsonString(String json) {
    return ensureInitialized().decodeJson<FamilyMembersMembersUnionUnknown>(
      json,
    );
  }
}

mixin FamilyMembersMembersUnionUnknownMappable {
  String toJsonString() {
    return FamilyMembersMembersUnionUnknownMapper.ensureInitialized()
        .encodeJson<FamilyMembersMembersUnionUnknown>(
          this as FamilyMembersMembersUnionUnknown,
        );
  }

  Map<String, dynamic> toJson() {
    return FamilyMembersMembersUnionUnknownMapper.ensureInitialized()
        .encodeMap<FamilyMembersMembersUnionUnknown>(
          this as FamilyMembersMembersUnionUnknown,
        );
  }

  FamilyMembersMembersUnionUnknownCopyWith<
    FamilyMembersMembersUnionUnknown,
    FamilyMembersMembersUnionUnknown,
    FamilyMembersMembersUnionUnknown
  >
  get copyWith =>
      _FamilyMembersMembersUnionUnknownCopyWithImpl<
        FamilyMembersMembersUnionUnknown,
        FamilyMembersMembersUnionUnknown
      >(this as FamilyMembersMembersUnionUnknown, $identity, $identity);
  @override
  String toString() {
    return FamilyMembersMembersUnionUnknownMapper.ensureInitialized()
        .stringifyValue(this as FamilyMembersMembersUnionUnknown);
  }

  @override
  bool operator ==(Object other) {
    return FamilyMembersMembersUnionUnknownMapper.ensureInitialized()
        .equalsValue(this as FamilyMembersMembersUnionUnknown, other);
  }

  @override
  int get hashCode {
    return FamilyMembersMembersUnionUnknownMapper.ensureInitialized().hashValue(
      this as FamilyMembersMembersUnionUnknown,
    );
  }
}

extension FamilyMembersMembersUnionUnknownValueCopy<$R, $Out>
    on ObjectCopyWith<$R, FamilyMembersMembersUnionUnknown, $Out> {
  FamilyMembersMembersUnionUnknownCopyWith<
    $R,
    FamilyMembersMembersUnionUnknown,
    $Out
  >
  get $asFamilyMembersMembersUnionUnknown => $base.as(
    (v, t, t2) =>
        _FamilyMembersMembersUnionUnknownCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class FamilyMembersMembersUnionUnknownCopyWith<
  $R,
  $In extends FamilyMembersMembersUnionUnknown,
  $Out
>
    implements FamilyMembersMembersUnionCopyWith<$R, $In, $Out> {
  ...
  FamilyMembersMembersUnionUnknownCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  );
}

class _FamilyMembersMembersUnionUnknownCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, FamilyMembersMembersUnionUnknown, $Out>
    implements
        FamilyMembersMembersUnionUnknownCopyWith<
          $R,
          FamilyMembersMembersUnionUnknown,
  ...
  @override
  late final ClassMapperBase<FamilyMembersMembersUnionUnknown> $mapper =
      FamilyMembersMembersUnionUnknownMapper.ensureInitialized();
  @override
  MapCopyWith<$R, String, dynamic, ObjectCopyWith<$R, dynamic, dynamic>>
  ...
  @override
  FamilyMembersMembersUnionUnknown $make(CopyWithData data) =>
      FamilyMembersMembersUnionUnknown(data.get(#json, or: $value.json));
  ...
  >
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _FamilyMembersMembersUnionUnknownCopyWithImpl<$R2, $Out2>(
        $value,
        $cast,
        t,
      );
