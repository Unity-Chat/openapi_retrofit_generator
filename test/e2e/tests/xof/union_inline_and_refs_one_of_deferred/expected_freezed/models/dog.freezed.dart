...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Dog&&(identical(other.barkSound, barkSound) || other.barkSound == barkSound));
}
...
@override
String toString() {
  return 'Dog(barkSound: $barkSound)';
}
...
/// Create a copy of Dog
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? barkSound = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String barkSound)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Dog() when $default != null:
return $default(_that.barkSound);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String barkSound)  $default,) {final _that = this;
switch (_that) {
case _Dog():
return $default(_that.barkSound);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String barkSound)?  $default,) {final _that = this;
switch (_that) {
case _Dog() when $default != null:
return $default(_that.barkSound);case _:
  return null;
...
class _Dog implements Dog {
  const _Dog({required this.barkSound});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Dog&&(identical(other.barkSound, barkSound) || other.barkSound == barkSound));
}
...
/// Create a copy of Dog
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? barkSound = null,}) {
  return _then(_Dog(
barkSound: null == barkSound ? _self.barkSound : barkSound // ignore: cast_nullable_to_non_nullable
as String,
  ));
