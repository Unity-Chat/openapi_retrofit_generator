...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Cat&&(identical(other.mewCount, mewCount) || other.mewCount == mewCount));
}
...
/// Create a copy of Cat
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? mewCount = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int mewCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Cat() when $default != null:
return $default(_that.mewCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int mewCount)  $default,) {final _that = this;
switch (_that) {
case _Cat():
return $default(_that.mewCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int mewCount)?  $default,) {final _that = this;
switch (_that) {
case _Cat() when $default != null:
return $default(_that.mewCount);case _:
  return null;
...
class _Cat implements Cat {
  const _Cat({required this.mewCount});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Cat&&(identical(other.mewCount, mewCount) || other.mewCount == mewCount));
}
...
/// Create a copy of Cat
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? mewCount = null,}) {
  return _then(_Cat(
mewCount: null == mewCount ? _self.mewCount : mewCount // ignore: cast_nullable_to_non_nullable
as int,
  ));
