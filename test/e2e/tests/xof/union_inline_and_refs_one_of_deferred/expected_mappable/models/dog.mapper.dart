...
class DogMapper extends ClassMapperBase<Dog> {
  ...
  @override
  final MappableFields<Dog> fields = const {#barkSound: _f$barkSound};

  static Dog _instantiate(DecodingData data) {
    return Dog(barkSound: data.dec(_f$barkSound));
  }
...
class _DogCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Dog, $Out>
  ...
  @override
  Dog $make(CopyWithData data) =>
      Dog(barkSound: data.get(#barkSound, or: $value.barkSound));
