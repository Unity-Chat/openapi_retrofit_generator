...
Map<String, dynamic> _$CatDogHumanUnionCatToJson(
  CatDogHumanUnionCat instance,
...
Map<String, dynamic> _$CatDogHumanUnionDogToJson(
  CatDogHumanUnionDog instance,
) => <String, dynamic>{'barkSound': instance.barkSound};

CatDogHumanUnionHuman _$CatDogHumanUnionHumanFromJson(
  Map<String, dynamic> json,
) => CatDogHumanUnionHuman(job: json['job'] as String);

Map<String, dynamic> _$CatDogHumanUnionHumanToJson(
  CatDogHumanUnionHuman instance,
