...
class _ClientClient implements ClientClient {
  ...
  Future<ApiV1CategoryListResponse> apiV1CategoryList({
    required ApiV1CategoryListRequest body,
  }) async {
    ...
    final _options = _setStreamType<ApiV1CategoryListResponse>(
    ...
    late ApiV1CategoryListResponse _value;
    try {
      _value = ApiV1CategoryListResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
