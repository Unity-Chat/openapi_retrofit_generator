...
class _UserClient implements UserClient {
  ...
  @override
  Future<UserInfoDto> getApiUserInfo({int? limit, List<String>? tags}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'limit': limit, r'tags': tags};
  ...
  @override
  Future<void> patchApiUserIdAvatar({int? id, MultipartFile? avatar}) async {
    final _extra = <String, dynamic>{};
