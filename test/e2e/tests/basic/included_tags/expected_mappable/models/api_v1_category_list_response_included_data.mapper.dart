...
class ApiV1CategoryListResponseIncludedDataMapper
  ...
  static ApiV1CategoryListResponseIncludedDataCategoryCategory? _$category(
    ApiV1CategoryListResponseIncludedData v,
  ) => v.category;
  static const Field<
    ApiV1CategoryListResponseIncludedData,
    ApiV1CategoryListResponseIncludedDataCategoryCategory
  >
  _f$category = Field('category', _$category, opt: true);
...
>
  ...
  $R call({
    String? dataField,
    ApiV1CategoryListResponseIncludedDataCategoryCategory? category,
    int? count,
  });
