...
@JsonKey(includeIfNull: false) String? get dataField;@JsonKey(includeIfNull: false) ApiV1CategoryListResponseIncludedDataCategoryCategory? get category;@JsonKey(includeIfNull: false) int? get count;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ApiV1CategoryListResponseIncludedData&&(identical(other.dataField, dataField) || other.dataField == dataField)&&(identical(other.category, category) || other.category == category)&&(identical(other.count, count) || other.count == count));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,dataField,category,count);

@override
String toString() {
  return 'ApiV1CategoryListResponseIncludedData(dataField: $dataField, category: $category, count: $count)';
}
...
@useResult
$Res call({
@JsonKey(includeIfNull: false) String? dataField,@JsonKey(includeIfNull: false) ApiV1CategoryListResponseIncludedDataCategoryCategory? category,@JsonKey(includeIfNull: false) int? count
});
...
/// Create a copy of ApiV1CategoryListResponseIncludedData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? dataField = freezed,Object? category = freezed,Object? count = freezed,}) {
  return _then(_self.copyWith(
dataField: freezed == dataField ? _self.dataField : dataField // ignore: cast_nullable_to_non_nullable
as String?,category: freezed == category ? _self.category : category // ignore: cast_nullable_to_non_nullable
as ApiV1CategoryListResponseIncludedDataCategoryCategory?,count: freezed == count ? _self.count : count // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  String? dataField, @JsonKey(includeIfNull: false)  ApiV1CategoryListResponseIncludedDataCategoryCategory? category, @JsonKey(includeIfNull: false)  int? count)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApiV1CategoryListResponseIncludedData() when $default != null:
return $default(_that.dataField,_that.category,_that.count);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  String? dataField, @JsonKey(includeIfNull: false)  ApiV1CategoryListResponseIncludedDataCategoryCategory? category, @JsonKey(includeIfNull: false)  int? count)  $default,) {final _that = this;
switch (_that) {
case _ApiV1CategoryListResponseIncludedData():
return $default(_that.dataField,_that.category,_that.count);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeIfNull: false)  String? dataField, @JsonKey(includeIfNull: false)  ApiV1CategoryListResponseIncludedDataCategoryCategory? category, @JsonKey(includeIfNull: false)  int? count)?  $default,) {final _that = this;
switch (_that) {
case _ApiV1CategoryListResponseIncludedData() when $default != null:
return $default(_that.dataField,_that.category,_that.count);case _:
  return null;
...
class _ApiV1CategoryListResponseIncludedData implements ApiV1CategoryListResponseIncludedData {
  const _ApiV1CategoryListResponseIncludedData({@JsonKey(includeIfNull: false) this.dataField, @JsonKey(includeIfNull: false) this.category, @JsonKey(includeIfNull: false) this.count});
...
@override@JsonKey(includeIfNull: false) final  ApiV1CategoryListResponseIncludedDataCategoryCategory? category;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ApiV1CategoryListResponseIncludedData&&(identical(other.dataField, dataField) || other.dataField == dataField)&&(identical(other.category, category) || other.category == category)&&(identical(other.count, count) || other.count == count));
}
...
/// Create a copy of ApiV1CategoryListResponseIncludedData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? dataField = freezed,Object? category = freezed,Object? count = freezed,}) {
