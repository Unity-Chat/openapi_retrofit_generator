...
@JsonKey(includeIfNull: false) String? get dataField;@JsonKey(includeIfNull: false) ApiV1CategoryListResponseIncludedDataLevelLevel? get level;@JsonKey(includeIfNull: false) int? get priority;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ApiV1CategoryListResponseIncludedData&&(identical(other.dataField, dataField) || other.dataField == dataField)&&(identical(other.level, level) || other.level == level)&&(identical(other.priority, priority) || other.priority == priority));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,dataField,level,priority);

@override
String toString() {
  return 'ApiV1CategoryListResponseIncludedData(dataField: $dataField, level: $level, priority: $priority)';
}
...
@useResult
$Res call({
@JsonKey(includeIfNull: false) String? dataField,@JsonKey(includeIfNull: false) ApiV1CategoryListResponseIncludedDataLevelLevel? level,@JsonKey(includeIfNull: false) int? priority
});
...
/// Create a copy of ApiV1CategoryListResponseIncludedData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? dataField = freezed,Object? level = freezed,Object? priority = freezed,}) {
  return _then(_self.copyWith(
dataField: freezed == dataField ? _self.dataField : dataField // ignore: cast_nullable_to_non_nullable
as String?,level: freezed == level ? _self.level : level // ignore: cast_nullable_to_non_nullable
as ApiV1CategoryListResponseIncludedDataLevelLevel?,priority: freezed == priority ? _self.priority : priority // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  String? dataField, @JsonKey(includeIfNull: false)  ApiV1CategoryListResponseIncludedDataLevelLevel? level, @JsonKey(includeIfNull: false)  int? priority)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApiV1CategoryListResponseIncludedData() when $default != null:
return $default(_that.dataField,_that.level,_that.priority);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  String? dataField, @JsonKey(includeIfNull: false)  ApiV1CategoryListResponseIncludedDataLevelLevel? level, @JsonKey(includeIfNull: false)  int? priority)  $default,) {final _that = this;
switch (_that) {
case _ApiV1CategoryListResponseIncludedData():
return $default(_that.dataField,_that.level,_that.priority);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeIfNull: false)  String? dataField, @JsonKey(includeIfNull: false)  ApiV1CategoryListResponseIncludedDataLevelLevel? level, @JsonKey(includeIfNull: false)  int? priority)?  $default,) {final _that = this;
switch (_that) {
case _ApiV1CategoryListResponseIncludedData() when $default != null:
return $default(_that.dataField,_that.level,_that.priority);case _:
  return null;
...
class _ApiV1CategoryListResponseIncludedData implements ApiV1CategoryListResponseIncludedData {
  const _ApiV1CategoryListResponseIncludedData({@JsonKey(includeIfNull: false) this.dataField, @JsonKey(includeIfNull: false) this.level, @JsonKey(includeIfNull: false) this.priority});
...
@override@JsonKey(includeIfNull: false) final  ApiV1CategoryListResponseIncludedDataLevelLevel? level;
@override@JsonKey(includeIfNull: false) final  int? priority;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ApiV1CategoryListResponseIncludedData&&(identical(other.dataField, dataField) || other.dataField == dataField)&&(identical(other.level, level) || other.level == level)&&(identical(other.priority, priority) || other.priority == priority));
}
...
/// Create a copy of ApiV1CategoryListResponseIncludedData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? dataField = freezed,Object? level = freezed,Object? priority = freezed,}) {
