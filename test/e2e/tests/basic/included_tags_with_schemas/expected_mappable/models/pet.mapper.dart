...
class PetMapper extends ClassMapperBase<Pet> {
  ...
  static PetAvailabilityAvailability? _$availability(Pet v) => v.availability;
  static const Field<Pet, PetAvailabilityAvailability> _f$availability = Field(
    'availability',
    _$availability,
    opt: true,
  );
...
abstract class PetCopyWith<$R, $In extends Pet, $Out>
  ...
  $R call({
    int? id,
    String? name,
    PetAvailabilityAvailability? availability,
    Category? category,
  });
