...
_$EventInstallationUpdatedPropertiesFromJson(Map<String, dynamic> json) =>
    _EventInstallationUpdatedProperties(version: json['version'] as String);

Map<String, dynamic> _$EventInstallationUpdatedPropertiesToJson(
  _EventInstallationUpdatedProperties instance,
