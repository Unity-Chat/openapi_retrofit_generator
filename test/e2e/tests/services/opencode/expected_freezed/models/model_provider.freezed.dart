...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ModelProvider&&(identical(other.npm, npm) || other.npm == npm));
}
...
class _ModelProvider implements ModelProvider {
  const _ModelProvider({required this.npm});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ModelProvider&&(identical(other.npm, npm) || other.npm == npm));
}
