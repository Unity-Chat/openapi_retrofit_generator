...
@JsonKey(name: 'small_model') String? get smallModel;/// Custom username to display in conversations instead of system username
 ...
 Map<String, McpMcpUnion>? get mcp; Map<String, Formatter>? get formatter; Map<String, LspLspUnion>? get lsp;/// Additional instruction files or patterns to include
...
as Map<String, McpMcpUnion>?,formatter: freezed == formatter ? _self.formatter : formatter // ignore: cast_nullable_to_non_nullable
as Map<String, Formatter>?,lsp: freezed == lsp ? _self.lsp : lsp // ignore: cast_nullable_to_non_nullable
as Map<String, LspLspUnion>?,instructions: freezed == instructions ? _self.instructions : instructions // ignore: cast_nullable_to_non_nullable
...
/// MCP (Model Context Protocol) server configurations
 final  Map<String, McpMcpUnion>? _mcp;
/// MCP (Model Context Protocol) server configurations
@override Map<String, McpMcpUnion>? get mcp {
  final value = _mcp;
  if (value == null) return null;
...
@override Map<String, Formatter>? get formatter {
 ...
 final  Map<String, LspLspUnion>? _lsp;
@override Map<String, LspLspUnion>? get lsp {
  final value = _lsp;
  if (value == null) return null;
...
as Map<String, McpMcpUnion>?,formatter: freezed == formatter ? _self._formatter : formatter // ignore: cast_nullable_to_non_nullable
as Map<String, Formatter>?,lsp: freezed == lsp ? _self._lsp : lsp // ignore: cast_nullable_to_non_nullable
as Map<String, LspLspUnion>?,instructions: freezed == instructions ? _self._instructions : instructions // ignore: cast_nullable_to_non_nullable
as List<String>?,layout: freezed == layout ? _self.layout : layout // ignore: cast_nullable_to_non_nullable
as LayoutConfig?,configPermission: freezed == configPermission ? _self.configPermission : configPermission // ignore: cast_nullable_to_non_nullable
