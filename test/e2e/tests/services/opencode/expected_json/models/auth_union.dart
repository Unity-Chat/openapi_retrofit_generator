...
class AuthUnionOAuth {
  ...
  factory AuthUnionOAuth.fromJson(Map<String, dynamic> json) =>
...
class AuthUnionApiAuth {
  ...
  factory AuthUnionApiAuth.fromJson(Map<String, dynamic> json) =>
...
class AuthUnionWellKnownAuth {
  ...
  factory AuthUnionWellKnownAuth.fromJson(Map<String, dynamic> json) =>
