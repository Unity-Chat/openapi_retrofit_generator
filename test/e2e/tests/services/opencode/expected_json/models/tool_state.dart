...
class ToolStateToolStatePending {
  ...
  factory ToolStateToolStatePending.fromJson(Map<String, dynamic> json) =>
      _$ToolStateToolStatePendingFromJson(json);

  Map<String, dynamic> toJson() => _$ToolStateToolStatePendingToJson(this);
}
...
class ToolStateToolStateRunning {
  ...
  Map<String, dynamic> toJson() => _$ToolStateToolStateRunningToJson(this);
}
...
class ToolStateToolStateCompleted {
  ...
  factory ToolStateToolStateCompleted.fromJson(Map<String, dynamic> json) =>
      _$ToolStateToolStateCompletedFromJson(json);

  Map<String, dynamic> toJson() => _$ToolStateToolStateCompletedToJson(this);
}
...
class ToolStateToolStateError {
  ...
  Map<String, dynamic> toJson() => _$ToolStateToolStateErrorToJson(this);
}
