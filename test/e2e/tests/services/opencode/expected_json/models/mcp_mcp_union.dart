...
class McpMcpUnionMcpLocalConfig {
  ...
  factory McpMcpUnionMcpLocalConfig.fromJson(Map<String, dynamic> json) =>
      _$McpMcpUnionMcpLocalConfigFromJson(json);

  Map<String, dynamic> toJson() => _$McpMcpUnionMcpLocalConfigToJson(this);
}
...
class McpMcpUnionMcpRemoteConfig {
  ...
  factory McpMcpUnionMcpRemoteConfig.fromJson(Map<String, dynamic> json) =>
      _$McpMcpUnionMcpRemoteConfigFromJson(json);

  Map<String, dynamic> toJson() => _$McpMcpUnionMcpRemoteConfigToJson(this);
}
