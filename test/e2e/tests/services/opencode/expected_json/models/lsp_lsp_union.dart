...
class LspLspUnionVariant1 {
  ...
  factory LspLspUnionVariant1.fromJson(Map<String, dynamic> json) =>
      _$LspLspUnionVariant1FromJson(json);

  Map<String, dynamic> toJson() => _$LspLspUnionVariant1ToJson(this);
}
...
class LspLspUnionVariant2 {
  ...
  factory LspLspUnionVariant2.fromJson(Map<String, dynamic> json) =>
      _$LspLspUnionVariant2FromJson(json);

  Map<String, dynamic> toJson() => _$LspLspUnionVariant2ToJson(this);
}
