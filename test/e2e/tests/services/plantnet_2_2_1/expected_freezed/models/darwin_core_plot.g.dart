...
_DarwinCorePlot _$DarwinCorePlotFromJson(Map<String, dynamic> json) =>
    _DarwinCorePlot(
      ...
      ownerInstitutionCodeProperty:
          json['ownerInstitutionCodeProperty'] as String,
      ...
      eunis: json['eunis'] == null
          ? null
          : Eunis.fromJson(json['eunis'] as Map<String, dynamic>),
      ...
      media: (json['media'] as List<dynamic>?)
          ?.map((e) => Model63.fromJson(e as Map<String, dynamic>))
          .toList(),
      species: (json['species'] as List<dynamic>?)
          ?.map((e) => Model65.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$DarwinCorePlotToJson(_DarwinCorePlot instance) =>
    <String, dynamic>{
      'id': instance.id,
