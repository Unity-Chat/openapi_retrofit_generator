...
_PartnerObservation _$PartnerObservationFromJson(Map<String, dynamic> json) =>
    _PartnerObservation(
      ...
      images: (json['images'] as List<dynamic>)
          .map((e) => Model26.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      groups: (json['groups'] as List<dynamic>?)
          ?.map((e) => Model25.fromJson(e as Map<String, dynamic>))
          .toList(),
      dateUpdatedRemote: json['dateUpdatedRemote'] as num?,
      sharedId: json['sharedId'] as String?,
      censored: json['censored'] as bool?,
      votes: (json['votes'] as List<dynamic>?)
          ?.map((e) => Model28.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$PartnerObservationToJson(_PartnerObservation instance) =>
    <String, dynamic>{
      'id': instance.id,
