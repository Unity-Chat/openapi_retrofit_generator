...
_DarwinCoreOccurrence _$DarwinCoreOccurrenceFromJson(
  ...
  identificationVerificationStatus:
      json['identificationVerificationStatus'] as String,
  ...
  media: (json['media'] as List<dynamic>?)
      ?.map((e) => Model33.fromJson(e as Map<String, dynamic>))
      .toList(),
  identifications: (json['identifications'] as List<dynamic>?)
      ?.map((e) => Model34.fromJson(e as Map<String, dynamic>))
      .toList(),
  votes: (json['votes'] as List<dynamic>?)
      ?.map((e) => Model35.fromJson(e as Map<String, dynamic>))
      .toList(),
  comments: (json['comments'] as List<dynamic>?)
      ?.map((e) => Model37.fromJson(e as Map<String, dynamic>))
      .toList(),
);

Map<String, dynamic> _$DarwinCoreOccurrenceToJson(
  _DarwinCoreOccurrence instance,
) => <String, dynamic>{
  'id': instance.id,
