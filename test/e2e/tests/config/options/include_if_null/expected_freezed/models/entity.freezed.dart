...
mixin _$Entity {
 ...
 String get id; DateTime get createdAt;@JsonKey(includeIfNull: false) String? get name;@JsonKey(includeIfNull: false) String? get description;@JsonKey(includeIfNull: false) DateTime? get updatedAt;
...
@useResult
$Res call({
 String id, DateTime createdAt,@JsonKey(includeIfNull: false) String? name,@JsonKey(includeIfNull: false) String? description,@JsonKey(includeIfNull: false) DateTime? updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String id,  DateTime createdAt,  DateTime dateOfBirth, @JsonKey(includeIfNull: false)  String? name, @JsonKey(includeIfNull: false)  String? description, @JsonKey(includeIfNull: false)  DateTime? updatedAt, @JsonKey(includeIfNull: false)  String? nationality, @JsonKey(includeIfNull: false)  String? occupation, @JsonKey(includeIfNull: false)  Map<String, String>? socialProfiles)?  person,TResult Function( String id,  DateTime createdAt,  String registrationNumber, @JsonKey(includeIfNull: false)  String? name, @JsonKey(includeIfNull: false)  String? description, @JsonKey(includeIfNull: false)  DateTime? updatedAt, @JsonKey(includeIfNull: false)  DateTime? foundedDate, @JsonKey(includeIfNull: false)  String? industry, @JsonKey(includeIfNull: false)  int? employeeCount, @JsonKey(includeIfNull: false)  double? revenue)?  organization,required TResult orElse(),}) {final _that = this;
switch (_that) {
case EntityPerson() when person != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String id,  DateTime createdAt,  DateTime dateOfBirth, @JsonKey(includeIfNull: false)  String? name, @JsonKey(includeIfNull: false)  String? description, @JsonKey(includeIfNull: false)  DateTime? updatedAt, @JsonKey(includeIfNull: false)  String? nationality, @JsonKey(includeIfNull: false)  String? occupation, @JsonKey(includeIfNull: false)  Map<String, String>? socialProfiles)  person,required TResult Function( String id,  DateTime createdAt,  String registrationNumber, @JsonKey(includeIfNull: false)  String? name, @JsonKey(includeIfNull: false)  String? description, @JsonKey(includeIfNull: false)  DateTime? updatedAt, @JsonKey(includeIfNull: false)  DateTime? foundedDate, @JsonKey(includeIfNull: false)  String? industry, @JsonKey(includeIfNull: false)  int? employeeCount, @JsonKey(includeIfNull: false)  double? revenue)  organization,}) {final _that = this;
switch (_that) {
case EntityPerson():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String id,  DateTime createdAt,  DateTime dateOfBirth, @JsonKey(includeIfNull: false)  String? name, @JsonKey(includeIfNull: false)  String? description, @JsonKey(includeIfNull: false)  DateTime? updatedAt, @JsonKey(includeIfNull: false)  String? nationality, @JsonKey(includeIfNull: false)  String? occupation, @JsonKey(includeIfNull: false)  Map<String, String>? socialProfiles)?  person,TResult? Function( String id,  DateTime createdAt,  String registrationNumber, @JsonKey(includeIfNull: false)  String? name, @JsonKey(includeIfNull: false)  String? description, @JsonKey(includeIfNull: false)  DateTime? updatedAt, @JsonKey(includeIfNull: false)  DateTime? foundedDate, @JsonKey(includeIfNull: false)  String? industry, @JsonKey(includeIfNull: false)  int? employeeCount, @JsonKey(includeIfNull: false)  double? revenue)?  organization,}) {final _that = this;
switch (_that) {
case EntityPerson() when person != null:
return person(_that.id,_that.createdAt,_that.dateOfBirth,_that.name,_that.description,_that.updatedAt,_that.nationality,_that.occupation,_that.socialProfiles);case EntityOrganization() when organization != null:
return organization(_that.id,_that.createdAt,_that.registrationNumber,_that.name,_that.description,_that.updatedAt,_that.foundedDate,_that.industry,_that.employeeCount,_that.revenue);case _:
...
class EntityPerson implements Entity {
  const EntityPerson({required this.id, required this.createdAt, required this.dateOfBirth, @JsonKey(includeIfNull: false) this.name, @JsonKey(includeIfNull: false) this.description, @JsonKey(includeIfNull: false) this.updatedAt, @JsonKey(includeIfNull: false) this.nationality, @JsonKey(includeIfNull: false) this.occupation, @JsonKey(includeIfNull: false) final  Map<String, String>? socialProfiles, final  String? $type}): _socialProfiles = socialProfiles,$type = $type ?? 'person';
...
@JsonKey(includeIfNull: false) final  String? nationality;
@JsonKey(includeIfNull: false) final  String? occupation;
 final  Map<String, String>? _socialProfiles;
@JsonKey(includeIfNull: false) Map<String, String>? get socialProfiles {
...
@override @useResult
$Res call({
 String id, DateTime createdAt, DateTime dateOfBirth,@JsonKey(includeIfNull: false) String? name,@JsonKey(includeIfNull: false) String? description,@JsonKey(includeIfNull: false) DateTime? updatedAt,@JsonKey(includeIfNull: false) String? nationality,@JsonKey(includeIfNull: false) String? occupation,@JsonKey(includeIfNull: false) Map<String, String>? socialProfiles
});
...
class EntityOrganization implements Entity {
  const EntityOrganization({required this.id, required this.createdAt, required this.registrationNumber, @JsonKey(includeIfNull: false) this.name, @JsonKey(includeIfNull: false) this.description, @JsonKey(includeIfNull: false) this.updatedAt, @JsonKey(includeIfNull: false) this.foundedDate, @JsonKey(includeIfNull: false) this.industry, @JsonKey(includeIfNull: false) this.employeeCount, @JsonKey(includeIfNull: false) this.revenue, final  String? $type}): $type = $type ?? 'organization';
...
@override@JsonKey(includeIfNull: false) final  String? description;
@override@JsonKey(includeIfNull: false) final  DateTime? updatedAt;
@JsonKey(includeIfNull: false) final  DateTime? foundedDate;
@JsonKey(includeIfNull: false) final  String? industry;
@JsonKey(includeIfNull: false) final  int? employeeCount;
@JsonKey(includeIfNull: false) final  double? revenue;
...
@override @useResult
$Res call({
 String id, DateTime createdAt, String registrationNumber,@JsonKey(includeIfNull: false) String? name,@JsonKey(includeIfNull: false) String? description,@JsonKey(includeIfNull: false) DateTime? updatedAt,@JsonKey(includeIfNull: false) DateTime? foundedDate,@JsonKey(includeIfNull: false) String? industry,@JsonKey(includeIfNull: false) int? employeeCount,@JsonKey(includeIfNull: false) double? revenue
});
