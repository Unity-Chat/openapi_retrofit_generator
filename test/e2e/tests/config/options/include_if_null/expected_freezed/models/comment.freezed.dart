...
mixin _$Comment {
 ...
 String get id; String get content; String get authorId; DateTime get createdAt; int get depth; int get likeCount;@JsonKey(includeIfNull: false) User? get author;@JsonKey(includeIfNull: false) String? get postId;/// Parent comment ID (for nested replies)
@JsonKey(includeIfNull: false) String? get parentId;/// Circular reference to parent comment
@JsonKey(includeIfNull: false) Comment? get parent;/// Nested replies (circular)
@JsonKey(includeIfNull: false) List<Comment>? get replies;@JsonKey(includeIfNull: false) DateTime? get updatedAt;@JsonKey(includeIfNull: false) DateTime? get deletedAt;
...
@useResult
$Res call({
 String id, String content, String authorId, DateTime createdAt, int depth, int likeCount,@JsonKey(includeIfNull: false) User? author,@JsonKey(includeIfNull: false) String? postId,@JsonKey(includeIfNull: false) String? parentId,@JsonKey(includeIfNull: false) Comment? parent,@JsonKey(includeIfNull: false) List<Comment>? replies,@JsonKey(includeIfNull: false) DateTime? updatedAt,@JsonKey(includeIfNull: false) DateTime? deletedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String content,  String authorId,  DateTime createdAt,  int depth,  int likeCount, @JsonKey(includeIfNull: false)  User? author, @JsonKey(includeIfNull: false)  String? postId, @JsonKey(includeIfNull: false)  String? parentId, @JsonKey(includeIfNull: false)  Comment? parent, @JsonKey(includeIfNull: false)  List<Comment>? replies, @JsonKey(includeIfNull: false)  DateTime? updatedAt, @JsonKey(includeIfNull: false)  DateTime? deletedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Comment() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String content,  String authorId,  DateTime createdAt,  int depth,  int likeCount, @JsonKey(includeIfNull: false)  User? author, @JsonKey(includeIfNull: false)  String? postId, @JsonKey(includeIfNull: false)  String? parentId, @JsonKey(includeIfNull: false)  Comment? parent, @JsonKey(includeIfNull: false)  List<Comment>? replies, @JsonKey(includeIfNull: false)  DateTime? updatedAt, @JsonKey(includeIfNull: false)  DateTime? deletedAt)  $default,) {final _that = this;
switch (_that) {
case _Comment():
return $default(_that.id,_that.content,_that.authorId,_that.createdAt,_that.depth,_that.likeCount,_that.author,_that.postId,_that.parentId,_that.parent,_that.replies,_that.updatedAt,_that.deletedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String content,  String authorId,  DateTime createdAt,  int depth,  int likeCount, @JsonKey(includeIfNull: false)  User? author, @JsonKey(includeIfNull: false)  String? postId, @JsonKey(includeIfNull: false)  String? parentId, @JsonKey(includeIfNull: false)  Comment? parent, @JsonKey(includeIfNull: false)  List<Comment>? replies, @JsonKey(includeIfNull: false)  DateTime? updatedAt, @JsonKey(includeIfNull: false)  DateTime? deletedAt)?  $default,) {final _that = this;
switch (_that) {
case _Comment() when $default != null:
return $default(_that.id,_that.content,_that.authorId,_that.createdAt,_that.depth,_that.likeCount,_that.author,_that.postId,_that.parentId,_that.parent,_that.replies,_that.updatedAt,_that.deletedAt);case _:
  return null;
...
class _Comment implements Comment {
  const _Comment({required this.id, required this.content, required this.authorId, required this.createdAt, this.depth = 0, this.likeCount = 0, @JsonKey(includeIfNull: false) this.author, @JsonKey(includeIfNull: false) this.postId, @JsonKey(includeIfNull: false) this.parentId, @JsonKey(includeIfNull: false) this.parent, @JsonKey(includeIfNull: false) final  List<Comment>? replies, @JsonKey(includeIfNull: false) this.updatedAt, @JsonKey(includeIfNull: false) this.deletedAt}): _replies = replies;
...
@override@JsonKey(includeIfNull: false) final  String? postId;
/// Parent comment ID (for nested replies)
@override@JsonKey(includeIfNull: false) final  String? parentId;
/// Circular reference to parent comment
@override@JsonKey(includeIfNull: false) final  Comment? parent;
/// Nested replies (circular)
 final  List<Comment>? _replies;
/// Nested replies (circular)
@override@JsonKey(includeIfNull: false) List<Comment>? get replies {
