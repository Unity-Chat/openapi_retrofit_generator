...
mixin _$PostSearchResult {
 ...
 PostSearchResultTypeType get type; PostModel get post;@JsonKey(includeIfNull: false) double? get score;@JsonKey(includeIfNull: false) List<String>? get highlights;
...
@useResult
$Res call({
 PostSearchResultTypeType type, PostModel post,@JsonKey(includeIfNull: false) double? score,@JsonKey(includeIfNull: false) List<String>? highlights
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PostSearchResultTypeType type,  PostModel post, @JsonKey(includeIfNull: false)  double? score, @JsonKey(includeIfNull: false)  List<String>? highlights)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PostSearchResult() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PostSearchResultTypeType type,  PostModel post, @JsonKey(includeIfNull: false)  double? score, @JsonKey(includeIfNull: false)  List<String>? highlights)  $default,) {final _that = this;
switch (_that) {
case _PostSearchResult():
return $default(_that.type,_that.post,_that.score,_that.highlights);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PostSearchResultTypeType type,  PostModel post, @JsonKey(includeIfNull: false)  double? score, @JsonKey(includeIfNull: false)  List<String>? highlights)?  $default,) {final _that = this;
switch (_that) {
case _PostSearchResult() when $default != null:
return $default(_that.type,_that.post,_that.score,_that.highlights);case _:
  return null;
...
class _PostSearchResult implements PostSearchResult {
  const _PostSearchResult({required this.type, required this.post, @JsonKey(includeIfNull: false) this.score, @JsonKey(includeIfNull: false) final  List<String>? highlights}): _highlights = highlights;
...
@override@JsonKey(includeIfNull: false) List<String>? get highlights {
