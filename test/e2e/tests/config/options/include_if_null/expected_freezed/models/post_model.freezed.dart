...
class _PostModel implements PostModel {
  const _PostModel({required this.id, required this.title, required this.content, required this.authorId, required this.status, required this.createdAt, this.viewCount = 0, this.likeCount = 0, @JsonKey(includeIfNull: false) this.excerpt, @JsonKey(includeIfNull: false) this.author, @JsonKey(includeIfNull: false) final  List<String>? tags, @JsonKey(includeIfNull: false) final  List<Category>? categories, @JsonKey(includeIfNull: false) this.publishedAt, @JsonKey(includeIfNull: false) this.metadata, @JsonKey(includeIfNull: false) this.updatedAt}): _tags = tags,_categories = categories;
