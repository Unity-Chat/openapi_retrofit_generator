...
@JsonKey(includeIfNull: false) List<PostModel>? get posts;@JsonKey(includeIfNull: false, name: 'ListPostsResponsePagination') ListPostsResponsePagination? get listPostsResponsePagination;@JsonKey(includeIfNull: false) Map<String, String>? get metadata;
...
@useResult
$Res call({
@JsonKey(includeIfNull: false) List<PostModel>? posts,@JsonKey(includeIfNull: false, name: 'ListPostsResponsePagination') ListPostsResponsePagination? listPostsResponsePagination,@JsonKey(includeIfNull: false) Map<String, String>? metadata
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  List<PostModel>? posts, @JsonKey(includeIfNull: false, name: 'ListPostsResponsePagination')  ListPostsResponsePagination? listPostsResponsePagination, @JsonKey(includeIfNull: false)  Map<String, String>? metadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ListPostsResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  List<PostModel>? posts, @JsonKey(includeIfNull: false, name: 'ListPostsResponsePagination')  ListPostsResponsePagination? listPostsResponsePagination, @JsonKey(includeIfNull: false)  Map<String, String>? metadata)  $default,) {final _that = this;
switch (_that) {
case _ListPostsResponse():
return $default(_that.posts,_that.listPostsResponsePagination,_that.metadata);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeIfNull: false)  List<PostModel>? posts, @JsonKey(includeIfNull: false, name: 'ListPostsResponsePagination')  ListPostsResponsePagination? listPostsResponsePagination, @JsonKey(includeIfNull: false)  Map<String, String>? metadata)?  $default,) {final _that = this;
switch (_that) {
case _ListPostsResponse() when $default != null:
return $default(_that.posts,_that.listPostsResponsePagination,_that.metadata);case _:
  return null;
...
class _ListPostsResponse implements ListPostsResponse {
  const _ListPostsResponse({@JsonKey(includeIfNull: false) final  List<PostModel>? posts, @JsonKey(includeIfNull: false, name: 'ListPostsResponsePagination') this.listPostsResponsePagination, @JsonKey(includeIfNull: false) final  Map<String, String>? metadata}): _posts = posts,_metadata = metadata;
...
@override@JsonKey(includeIfNull: false, name: 'ListPostsResponsePagination') final  ListPostsResponsePagination? listPostsResponsePagination;
