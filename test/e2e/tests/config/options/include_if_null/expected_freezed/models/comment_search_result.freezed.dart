...
mixin _$CommentSearchResult {
 ...
 CommentSearchResultTypeType get type; Comment get comment;@JsonKey(includeIfNull: false) double? get score;
...
@useResult
$Res call({
 CommentSearchResultTypeType type, Comment comment,@JsonKey(includeIfNull: false) double? score
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CommentSearchResultTypeType type,  Comment comment, @JsonKey(includeIfNull: false)  double? score)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CommentSearchResult() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CommentSearchResultTypeType type,  Comment comment, @JsonKey(includeIfNull: false)  double? score)  $default,) {final _that = this;
switch (_that) {
case _CommentSearchResult():
return $default(_that.type,_that.comment,_that.score);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CommentSearchResultTypeType type,  Comment comment, @JsonKey(includeIfNull: false)  double? score)?  $default,) {final _that = this;
switch (_that) {
case _CommentSearchResult() when $default != null:
return $default(_that.type,_that.comment,_that.score);case _:
  return null;
...
class _CommentSearchResult implements CommentSearchResult {
  const _CommentSearchResult({required this.type, required this.comment, @JsonKey(includeIfNull: false) this.score});
