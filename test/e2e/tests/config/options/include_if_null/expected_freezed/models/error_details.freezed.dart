...
@JsonKey(includeIfNull: false) String? get field;@JsonKey(includeIfNull: false) String? get message;
...
@useResult
$Res call({
@JsonKey(includeIfNull: false) String? field,@JsonKey(includeIfNull: false) String? message
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  String? field, @JsonKey(includeIfNull: false)  String? message)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ErrorDetails() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  String? field, @JsonKey(includeIfNull: false)  String? message)  $default,) {final _that = this;
switch (_that) {
case _ErrorDetails():
return $default(_that.field,_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeIfNull: false)  String? field, @JsonKey(includeIfNull: false)  String? message)?  $default,) {final _that = this;
switch (_that) {
case _ErrorDetails() when $default != null:
return $default(_that.field,_that.message);case _:
  return null;
...
class _ErrorDetails implements ErrorDetails {
  const _ErrorDetails({@JsonKey(includeIfNull: false) this.field, @JsonKey(includeIfNull: false) this.message});
  factory _ErrorDetails.fromJson(Map<String, dynamic> json) => _$ErrorDetailsFromJson(json);

@override@JsonKey(includeIfNull: false) final  String? field;
