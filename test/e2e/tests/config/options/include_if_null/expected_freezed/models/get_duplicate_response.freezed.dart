...
@JsonKey(includeIfNull: false) Data? get data;@JsonKey(includeIfNull: false) GetDuplicateResponseMetadata? get metadata;
...
@useResult
$Res call({
@JsonKey(includeIfNull: false) Data? data,@JsonKey(includeIfNull: false) GetDuplicateResponseMetadata? metadata
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  Data? data, @JsonKey(includeIfNull: false)  GetDuplicateResponseMetadata? metadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GetDuplicateResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  Data? data, @JsonKey(includeIfNull: false)  GetDuplicateResponseMetadata? metadata)  $default,) {final _that = this;
switch (_that) {
case _GetDuplicateResponse():
return $default(_that.data,_that.metadata);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeIfNull: false)  Data? data, @JsonKey(includeIfNull: false)  GetDuplicateResponseMetadata? metadata)?  $default,) {final _that = this;
switch (_that) {
case _GetDuplicateResponse() when $default != null:
return $default(_that.data,_that.metadata);case _:
  return null;
...
class _GetDuplicateResponse implements GetDuplicateResponse {
  const _GetDuplicateResponse({@JsonKey(includeIfNull: false) this.data, @JsonKey(includeIfNull: false) this.metadata});
...
@override@JsonKey(includeIfNull: false) final  GetDuplicateResponseMetadata? metadata;
