...
@JsonKey(includeIfNull: false) Data? get data;@JsonKey(includeIfNull: false, name: 'GetDuplicateResponseMetadata') GetDuplicateResponseMetadata? get getDuplicateResponseMetadata;
...
@useResult
$Res call({
@JsonKey(includeIfNull: false) Data? data,@JsonKey(includeIfNull: false, name: 'GetDuplicateResponseMetadata') GetDuplicateResponseMetadata? getDuplicateResponseMetadata
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  Data? data, @JsonKey(includeIfNull: false, name: 'GetDuplicateResponseMetadata')  GetDuplicateResponseMetadata? getDuplicateResponseMetadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GetDuplicateResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  Data? data, @JsonKey(includeIfNull: false, name: 'GetDuplicateResponseMetadata')  GetDuplicateResponseMetadata? getDuplicateResponseMetadata)  $default,) {final _that = this;
switch (_that) {
case _GetDuplicateResponse():
return $default(_that.data,_that.getDuplicateResponseMetadata);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeIfNull: false)  Data? data, @JsonKey(includeIfNull: false, name: 'GetDuplicateResponseMetadata')  GetDuplicateResponseMetadata? getDuplicateResponseMetadata)?  $default,) {final _that = this;
switch (_that) {
case _GetDuplicateResponse() when $default != null:
return $default(_that.data,_that.getDuplicateResponseMetadata);case _:
  return null;
...
class _GetDuplicateResponse implements GetDuplicateResponse {
  const _GetDuplicateResponse({@JsonKey(includeIfNull: false) this.data, @JsonKey(includeIfNull: false, name: 'GetDuplicateResponseMetadata') this.getDuplicateResponseMetadata});
  factory _GetDuplicateResponse.fromJson(Map<String, dynamic> json) => _$GetDuplicateResponseFromJson(json);

@override@JsonKey(includeIfNull: false) final  Data? data;
@override@JsonKey(includeIfNull: false, name: 'GetDuplicateResponseMetadata') final  GetDuplicateResponseMetadata? getDuplicateResponseMetadata;
