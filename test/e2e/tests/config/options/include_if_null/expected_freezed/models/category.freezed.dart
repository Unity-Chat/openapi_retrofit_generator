...
mixin _$Category {
 ...
 String get id; String get name;@JsonKey(includeIfNull: false) String? get slug;/// Circular reference for nested categories
@JsonKey(includeIfNull: false) Category? get parent;
...
@useResult
$Res call({
 String id, String name,@JsonKey(includeIfNull: false) String? slug,@JsonKey(includeIfNull: false) Category? parent
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name, @JsonKey(includeIfNull: false)  String? slug, @JsonKey(includeIfNull: false)  Category? parent)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Category() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name, @JsonKey(includeIfNull: false)  String? slug, @JsonKey(includeIfNull: false)  Category? parent)  $default,) {final _that = this;
switch (_that) {
case _Category():
return $default(_that.id,_that.name,_that.slug,_that.parent);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name, @JsonKey(includeIfNull: false)  String? slug, @JsonKey(includeIfNull: false)  Category? parent)?  $default,) {final _that = this;
switch (_that) {
case _Category() when $default != null:
return $default(_that.id,_that.name,_that.slug,_that.parent);case _:
  return null;
...
class _Category implements Category {
  const _Category({required this.id, required this.name, @JsonKey(includeIfNull: false) this.slug, @JsonKey(includeIfNull: false) this.parent});
...
@override@JsonKey(includeIfNull: false) final  Category? parent;
