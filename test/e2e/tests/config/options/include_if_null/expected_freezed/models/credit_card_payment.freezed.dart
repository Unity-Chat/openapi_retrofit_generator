...
mixin _$CreditCardPayment {
 ...
 CreditCardPaymentPaymentTypePaymentType get paymentType; String get cardNumber; int get expiryMonth; int get expiryYear; String get cvv; double get amount;@JsonKey(includeIfNull: false) String? get cardholderName;
...
@useResult
$Res call({
 CreditCardPaymentPaymentTypePaymentType paymentType, String cardNumber, int expiryMonth, int expiryYear, String cvv, double amount,@JsonKey(includeIfNull: false) String? cardholderName
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CreditCardPaymentPaymentTypePaymentType paymentType,  String cardNumber,  int expiryMonth,  int expiryYear,  String cvv,  double amount, @JsonKey(includeIfNull: false)  String? cardholderName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreditCardPayment() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CreditCardPaymentPaymentTypePaymentType paymentType,  String cardNumber,  int expiryMonth,  int expiryYear,  String cvv,  double amount, @JsonKey(includeIfNull: false)  String? cardholderName)  $default,) {final _that = this;
switch (_that) {
case _CreditCardPayment():
return $default(_that.paymentType,_that.cardNumber,_that.expiryMonth,_that.expiryYear,_that.cvv,_that.amount,_that.cardholderName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CreditCardPaymentPaymentTypePaymentType paymentType,  String cardNumber,  int expiryMonth,  int expiryYear,  String cvv,  double amount, @JsonKey(includeIfNull: false)  String? cardholderName)?  $default,) {final _that = this;
switch (_that) {
case _CreditCardPayment() when $default != null:
return $default(_that.paymentType,_that.cardNumber,_that.expiryMonth,_that.expiryYear,_that.cvv,_that.amount,_that.cardholderName);case _:
  return null;
...
class _CreditCardPayment implements CreditCardPayment {
  const _CreditCardPayment({required this.paymentType, required this.cardNumber, required this.expiryMonth, required this.expiryYear, required this.cvv, required this.amount, @JsonKey(includeIfNull: false) this.cardholderName});
...
@override@JsonKey(includeIfNull: false) final  String? cardholderName;
