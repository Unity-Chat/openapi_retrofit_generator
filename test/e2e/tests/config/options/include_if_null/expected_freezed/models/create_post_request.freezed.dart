...
mixin _$CreatePostRequest {
 ...
 String get title; String get content; String get authorId;@JsonKey(includeIfNull: false) List<String>? get tags;@JsonKey(includeIfNull: false) DateTime? get publishAt;@JsonKey(includeIfNull: false) dynamic get metadata;
...
@useResult
$Res call({
 String title, String content, String authorId,@JsonKey(includeIfNull: false) List<String>? tags,@JsonKey(includeIfNull: false) DateTime? publishAt,@JsonKey(includeIfNull: false) dynamic metadata
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  String content,  String authorId, @JsonKey(includeIfNull: false)  List<String>? tags, @JsonKey(includeIfNull: false)  DateTime? publishAt, @JsonKey(includeIfNull: false)  dynamic metadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreatePostRequest() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  String content,  String authorId, @JsonKey(includeIfNull: false)  List<String>? tags, @JsonKey(includeIfNull: false)  DateTime? publishAt, @JsonKey(includeIfNull: false)  dynamic metadata)  $default,) {final _that = this;
switch (_that) {
case _CreatePostRequest():
return $default(_that.title,_that.content,_that.authorId,_that.tags,_that.publishAt,_that.metadata);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  String content,  String authorId, @JsonKey(includeIfNull: false)  List<String>? tags, @JsonKey(includeIfNull: false)  DateTime? publishAt, @JsonKey(includeIfNull: false)  dynamic metadata)?  $default,) {final _that = this;
switch (_that) {
case _CreatePostRequest() when $default != null:
return $default(_that.title,_that.content,_that.authorId,_that.tags,_that.publishAt,_that.metadata);case _:
  return null;
...
class _CreatePostRequest implements CreatePostRequest {
  const _CreatePostRequest({required this.title, required this.content, required this.authorId, @JsonKey(includeIfNull: false) final  List<String>? tags, @JsonKey(includeIfNull: false) this.publishAt, @JsonKey(includeIfNull: false) this.metadata}): _tags = tags;
...
@override@JsonKey(includeIfNull: false) final  DateTime? publishAt;
