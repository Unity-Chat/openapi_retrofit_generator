...
mixin _$CryptoPayment {
 ...
 CryptoPaymentPaymentTypePaymentType get paymentType; String get walletAddress; CryptoPaymentCryptocurrencyCryptocurrency get cryptocurrency; double get amount;@JsonKey(includeIfNull: false) String? get transactionHash;
...
@useResult
$Res call({
 CryptoPaymentPaymentTypePaymentType paymentType, String walletAddress, CryptoPaymentCryptocurrencyCryptocurrency cryptocurrency, double amount,@JsonKey(includeIfNull: false) String? transactionHash
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CryptoPaymentPaymentTypePaymentType paymentType,  String walletAddress,  CryptoPaymentCryptocurrencyCryptocurrency cryptocurrency,  double amount, @JsonKey(includeIfNull: false)  String? transactionHash)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CryptoPayment() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CryptoPaymentPaymentTypePaymentType paymentType,  String walletAddress,  CryptoPaymentCryptocurrencyCryptocurrency cryptocurrency,  double amount, @JsonKey(includeIfNull: false)  String? transactionHash)  $default,) {final _that = this;
switch (_that) {
case _CryptoPayment():
return $default(_that.paymentType,_that.walletAddress,_that.cryptocurrency,_that.amount,_that.transactionHash);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CryptoPaymentPaymentTypePaymentType paymentType,  String walletAddress,  CryptoPaymentCryptocurrencyCryptocurrency cryptocurrency,  double amount, @JsonKey(includeIfNull: false)  String? transactionHash)?  $default,) {final _that = this;
switch (_that) {
case _CryptoPayment() when $default != null:
return $default(_that.paymentType,_that.walletAddress,_that.cryptocurrency,_that.amount,_that.transactionHash);case _:
  return null;
...
class _CryptoPayment implements CryptoPayment {
  const _CryptoPayment({required this.paymentType, required this.walletAddress, required this.cryptocurrency, required this.amount, @JsonKey(includeIfNull: false) this.transactionHash});
...
@override@JsonKey(includeIfNull: false) final  String? transactionHash;
