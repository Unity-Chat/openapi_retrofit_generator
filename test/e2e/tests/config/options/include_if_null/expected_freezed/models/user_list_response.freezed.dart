...
mixin _$UserListResponse {
 ...
 List<User> get users; int get total;@JsonKey(includeIfNull: false) int? get page;@JsonKey(includeIfNull: false) int? get limit;
...
@useResult
$Res call({
 List<User> users, int total,@JsonKey(includeIfNull: false) int? page,@JsonKey(includeIfNull: false) int? limit
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<User> users,  int total, @JsonKey(includeIfNull: false)  int? page, @JsonKey(includeIfNull: false)  int? limit)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserListResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<User> users,  int total, @JsonKey(includeIfNull: false)  int? page, @JsonKey(includeIfNull: false)  int? limit)  $default,) {final _that = this;
switch (_that) {
case _UserListResponse():
return $default(_that.users,_that.total,_that.page,_that.limit);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<User> users,  int total, @JsonKey(includeIfNull: false)  int? page, @JsonKey(includeIfNull: false)  int? limit)?  $default,) {final _that = this;
switch (_that) {
case _UserListResponse() when $default != null:
return $default(_that.users,_that.total,_that.page,_that.limit);case _:
  return null;
...
class _UserListResponse implements UserListResponse {
  const _UserListResponse({required final  List<User> users, required this.total, @JsonKey(includeIfNull: false) this.page, @JsonKey(includeIfNull: false) this.limit}): _users = users;
...
@override@JsonKey(includeIfNull: false) final  int? limit;
