...
mixin _$CreateCommentRequest {
 ...
 String get content; String get authorId;@JsonKey(includeIfNull: false) String? get postId;@JsonKey(includeIfNull: false) String? get parentId;
...
@useResult
$Res call({
 String content, String authorId,@JsonKey(includeIfNull: false) String? postId,@JsonKey(includeIfNull: false) String? parentId
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String content,  String authorId, @JsonKey(includeIfNull: false)  String? postId, @JsonKey(includeIfNull: false)  String? parentId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateCommentRequest() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String content,  String authorId, @JsonKey(includeIfNull: false)  String? postId, @JsonKey(includeIfNull: false)  String? parentId)  $default,) {final _that = this;
switch (_that) {
case _CreateCommentRequest():
return $default(_that.content,_that.authorId,_that.postId,_that.parentId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String content,  String authorId, @JsonKey(includeIfNull: false)  String? postId, @JsonKey(includeIfNull: false)  String? parentId)?  $default,) {final _that = this;
switch (_that) {
case _CreateCommentRequest() when $default != null:
return $default(_that.content,_that.authorId,_that.postId,_that.parentId);case _:
  return null;
...
class _CreateCommentRequest implements CreateCommentRequest {
  const _CreateCommentRequest({required this.content, required this.authorId, @JsonKey(includeIfNull: false) this.postId, @JsonKey(includeIfNull: false) this.parentId});
