...
@JsonKey(includeIfNull: false) String? get query;@JsonKey(includeIfNull: false) Map<String, String>? get filters;
...
@useResult
$Res call({
@JsonKey(includeIfNull: false) String? query,@JsonKey(includeIfNull: false) Map<String, String>? filters
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  String? query, @JsonKey(includeIfNull: false)  Map<String, String>? filters)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SearchRequest() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  String? query, @JsonKey(includeIfNull: false)  Map<String, String>? filters)  $default,) {final _that = this;
switch (_that) {
case _SearchRequest():
return $default(_that.query,_that.filters);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeIfNull: false)  String? query, @JsonKey(includeIfNull: false)  Map<String, String>? filters)?  $default,) {final _that = this;
switch (_that) {
case _SearchRequest() when $default != null:
return $default(_that.query,_that.filters);case _:
  return null;
...
class _SearchRequest implements SearchRequest {
  const _SearchRequest({@JsonKey(includeIfNull: false) this.query, @JsonKey(includeIfNull: false) final  Map<String, String>? filters}): _filters = filters;
...
@override@JsonKey(includeIfNull: false) Map<String, String>? get filters {
