...
@JsonKey(includeIfNull: false) DateTime? get from;@JsonKey(includeIfNull: false) DateTime? get to;
...
@useResult
$Res call({
@JsonKey(includeIfNull: false) DateTime? from,@JsonKey(includeIfNull: false) DateTime? to
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  DateTime? from, @JsonKey(includeIfNull: false)  DateTime? to)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FiltersDateRange() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  DateTime? from, @JsonKey(includeIfNull: false)  DateTime? to)  $default,) {final _that = this;
switch (_that) {
case _FiltersDateRange():
return $default(_that.from,_that.to);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeIfNull: false)  DateTime? from, @JsonKey(includeIfNull: false)  DateTime? to)?  $default,) {final _that = this;
switch (_that) {
case _FiltersDateRange() when $default != null:
return $default(_that.from,_that.to);case _:
  return null;
...
class _FiltersDateRange implements FiltersDateRange {
  const _FiltersDateRange({@JsonKey(includeIfNull: false) this.from, @JsonKey(includeIfNull: false) this.to});
  factory _FiltersDateRange.fromJson(Map<String, dynamic> json) => _$FiltersDateRangeFromJson(json);

@override@JsonKey(includeIfNull: false) final  DateTime? from;
@override@JsonKey(includeIfNull: false) final  DateTime? to;
