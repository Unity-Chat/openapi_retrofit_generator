...
@JsonKey(includeIfNull: false) List<DataNestedData>? get data;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  List<DataNestedData>? data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DataNested() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  List<DataNestedData>? data)  $default,) {final _that = this;
switch (_that) {
case _DataNested():
return $default(_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeIfNull: false)  List<DataNestedData>? data)?  $default,) {final _that = this;
switch (_that) {
case _DataNested() when $default != null:
return $default(_that.data);case _:
  return null;
...
class _DataNested implements DataNested {
  const _DataNested({@JsonKey(includeIfNull: false) final  List<DataNestedData>? data}): _data = data;
  factory _DataNested.fromJson(Map<String, dynamic> json) => _$DataNestedFromJson(json);

 final  List<DataNestedData>? _data;
@override@JsonKey(includeIfNull: false) List<DataNestedData>? get data {
  final value = _data;
