...
mixin _$GetPostResponse {
 ...
 String get id; String get title; String get content; String get authorId; PostStatus get status; DateTime get createdAt; int get viewCount; int get likeCount;@JsonKey(includeIfNull: false) String? get excerpt;@JsonKey(includeIfNull: false) User? get author;@JsonKey(includeIfNull: false) List<String>? get tags;@JsonKey(includeIfNull: false) List<Category>? get categories;@JsonKey(includeIfNull: false) DateTime? get publishedAt;@JsonKey(includeIfNull: false) dynamic get metadata;@JsonKey(includeIfNull: false) DateTime? get updatedAt;@JsonKey(includeIfNull: false) List<Comment>? get comments;
...
@useResult
$Res call({
 String id, String title, String content, String authorId, PostStatus status, DateTime createdAt, int viewCount, int likeCount,@JsonKey(includeIfNull: false) String? excerpt,@JsonKey(includeIfNull: false) User? author,@JsonKey(includeIfNull: false) List<String>? tags,@JsonKey(includeIfNull: false) List<Category>? categories,@JsonKey(includeIfNull: false) DateTime? publishedAt,@JsonKey(includeIfNull: false) dynamic metadata,@JsonKey(includeIfNull: false) DateTime? updatedAt,@JsonKey(includeIfNull: false) List<Comment>? comments
});
...
class _GetPostResponse implements GetPostResponse {
  const _GetPostResponse({required this.id, required this.title, required this.content, required this.authorId, required this.status, required this.createdAt, this.viewCount = 0, this.likeCount = 0, @JsonKey(includeIfNull: false) this.excerpt, @JsonKey(includeIfNull: false) this.author, @JsonKey(includeIfNull: false) final  List<String>? tags, @JsonKey(includeIfNull: false) final  List<Category>? categories, @JsonKey(includeIfNull: false) this.publishedAt, @JsonKey(includeIfNull: false) this.metadata, @JsonKey(includeIfNull: false) this.updatedAt, @JsonKey(includeIfNull: false) final  List<Comment>? comments}): _tags = tags,_categories = categories,_comments = comments;
...
@override@JsonKey(includeIfNull: false) final  String? excerpt;
...
@override@JsonKey(includeIfNull: false) List<Category>? get categories {
...
@override@JsonKey(includeIfNull: false) final  DateTime? publishedAt;
