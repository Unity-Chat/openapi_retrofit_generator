...
@JsonKey(includeIfNull: false) List<SearchResult>? get results;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  List<SearchResult>? results)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SearchResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  List<SearchResult>? results)  $default,) {final _that = this;
switch (_that) {
case _SearchResponse():
return $default(_that.results);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeIfNull: false)  List<SearchResult>? results)?  $default,) {final _that = this;
switch (_that) {
case _SearchResponse() when $default != null:
return $default(_that.results);case _:
  return null;
...
class _SearchResponse implements SearchResponse {
  const _SearchResponse({@JsonKey(includeIfNull: false) final  List<SearchResult>? results}): _results = results;
  factory _SearchResponse.fromJson(Map<String, dynamic> json) => _$SearchResponseFromJson(json);

 final  List<SearchResult>? _results;
@override@JsonKey(includeIfNull: false) List<SearchResult>? get results {
