...
class _PaymentResponse implements PaymentResponse {
  const _PaymentResponse({required this.transactionId, required this.status, required this.amount, @JsonKey(includeIfNull: false) this.processedAt, @JsonKey(includeIfNull: false) this.details, this.currency = 'USD'});
