...
@JsonKey(includeIfNull: false) String? get authorId;@JsonKey(includeIfNull: false) List<String>? get tags;@JsonKey(includeIfNull: false, name: 'FiltersDateRange') FiltersDateRange? get filtersDateRange;
...
@useResult
$Res call({
@JsonKey(includeIfNull: false) String? authorId,@JsonKey(includeIfNull: false) List<String>? tags,@JsonKey(includeIfNull: false, name: 'FiltersDateRange') FiltersDateRange? filtersDateRange
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  String? authorId, @JsonKey(includeIfNull: false)  List<String>? tags, @JsonKey(includeIfNull: false, name: 'FiltersDateRange')  FiltersDateRange? filtersDateRange)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Filters() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  String? authorId, @JsonKey(includeIfNull: false)  List<String>? tags, @JsonKey(includeIfNull: false, name: 'FiltersDateRange')  FiltersDateRange? filtersDateRange)  $default,) {final _that = this;
switch (_that) {
case _Filters():
return $default(_that.authorId,_that.tags,_that.filtersDateRange);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeIfNull: false)  String? authorId, @JsonKey(includeIfNull: false)  List<String>? tags, @JsonKey(includeIfNull: false, name: 'FiltersDateRange')  FiltersDateRange? filtersDateRange)?  $default,) {final _that = this;
switch (_that) {
case _Filters() when $default != null:
return $default(_that.authorId,_that.tags,_that.filtersDateRange);case _:
  return null;
...
class _Filters implements Filters {
  const _Filters({@JsonKey(includeIfNull: false) this.authorId, @JsonKey(includeIfNull: false) final  List<String>? tags, @JsonKey(includeIfNull: false, name: 'FiltersDateRange') this.filtersDateRange}): _tags = tags;
...
@override@JsonKey(includeIfNull: false, name: 'FiltersDateRange') final  FiltersDateRange? filtersDateRange;
