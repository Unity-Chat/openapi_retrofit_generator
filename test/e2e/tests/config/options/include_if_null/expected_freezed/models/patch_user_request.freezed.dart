...
@JsonKey(includeIfNull: false) String? get email;@JsonKey(includeIfNull: false) String? get username;@JsonKey(includeIfNull: false) String? get firstName;@JsonKey(includeIfNull: false) String? get lastName;@JsonKey(includeIfNull: false) int? get age;@JsonKey(includeIfNull: false) String? get bio;@JsonKey(includeIfNull: false) UserSettings? get settings;
...
@useResult
$Res call({
@JsonKey(includeIfNull: false) String? email,@JsonKey(includeIfNull: false) String? username,@JsonKey(includeIfNull: false) String? firstName,@JsonKey(includeIfNull: false) String? lastName,@JsonKey(includeIfNull: false) int? age,@JsonKey(includeIfNull: false) String? bio,@JsonKey(includeIfNull: false) UserSettings? settings
});
...
class _PatchUserRequest implements PatchUserRequest {
  const _PatchUserRequest({@JsonKey(includeIfNull: false) this.email, @JsonKey(includeIfNull: false) this.username, @JsonKey(includeIfNull: false) this.firstName, @JsonKey(includeIfNull: false) this.lastName, @JsonKey(includeIfNull: false) this.age, @JsonKey(includeIfNull: false) this.bio, @JsonKey(includeIfNull: false) this.settings});
