...
class _PostsClient implements PostsClient {
  ...
  @override
  Future<ListPostsResponse> getPosts({Filters? filters}) async {
  ...
  @override
  Future<PostModel> postPosts({CreatePostRequest? body}) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<GetPostResponse> getPostsPostId({required String postId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
