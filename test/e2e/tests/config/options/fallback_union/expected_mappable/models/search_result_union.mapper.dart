...
class SearchResultUnionMapper extends ClassMapperBase<SearchResultUnion> {
  ...
  static SearchResultUnionMapper ensureInitialized() {
    if (_instance == null) {
      ...
      SearchResultUnionUnknownMapper.ensureInitialized();
    }
    return _instance!;
  }
...
class SearchResultUnionUnknownMapper
    extends ClassMapperBase<SearchResultUnionUnknown> {
  SearchResultUnionUnknownMapper._();

  static SearchResultUnionUnknownMapper? _instance;
  static SearchResultUnionUnknownMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(
        _instance = SearchResultUnionUnknownMapper._(),
      );
      SearchResultUnionMapper.ensureInitialized();
    }
    return _instance!;
  ...
  @override
  final String id = 'SearchResultUnionUnknown';

  static Map<String, dynamic> _$json(SearchResultUnionUnknown v) => v.json;
  static const Field<SearchResultUnionUnknown, Map<String, dynamic>> _f$json =
      Field('json', _$json);

  @override
  final MappableFields<SearchResultUnionUnknown> fields = const {
    #json: _f$json,
  };

  static SearchResultUnionUnknown _instantiate(DecodingData data) {
    return SearchResultUnionUnknown(data.dec(_f$json));
  }

  @override
  final Function instantiate = _instantiate;

  static SearchResultUnionUnknown fromJson(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<SearchResultUnionUnknown>(map);
  }

  static SearchResultUnionUnknown fromJsonString(String json) {
    return ensureInitialized().decodeJson<SearchResultUnionUnknown>(json);
  }
}

mixin SearchResultUnionUnknownMappable {
  String toJsonString() {
    return SearchResultUnionUnknownMapper.ensureInitialized()
        .encodeJson<SearchResultUnionUnknown>(this as SearchResultUnionUnknown);
  }

  Map<String, dynamic> toJson() {
    return SearchResultUnionUnknownMapper.ensureInitialized()
        .encodeMap<SearchResultUnionUnknown>(this as SearchResultUnionUnknown);
  }

  SearchResultUnionUnknownCopyWith<
    SearchResultUnionUnknown,
    SearchResultUnionUnknown,
    SearchResultUnionUnknown
  >
  get copyWith =>
      _SearchResultUnionUnknownCopyWithImpl<
        SearchResultUnionUnknown,
        SearchResultUnionUnknown
      >(this as SearchResultUnionUnknown, $identity, $identity);
  @override
  String toString() {
    return SearchResultUnionUnknownMapper.ensureInitialized().stringifyValue(
      this as SearchResultUnionUnknown,
    );
  }

  @override
  bool operator ==(Object other) {
    return SearchResultUnionUnknownMapper.ensureInitialized().equalsValue(
      this as SearchResultUnionUnknown,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return SearchResultUnionUnknownMapper.ensureInitialized().hashValue(
      this as SearchResultUnionUnknown,
    );
  }
}

extension SearchResultUnionUnknownValueCopy<$R, $Out>
    on ObjectCopyWith<$R, SearchResultUnionUnknown, $Out> {
  SearchResultUnionUnknownCopyWith<$R, SearchResultUnionUnknown, $Out>
  get $asSearchResultUnionUnknown => $base.as(
    (v, t, t2) => _SearchResultUnionUnknownCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class SearchResultUnionUnknownCopyWith<
  $R,
  $In extends SearchResultUnionUnknown,
  $Out
>
    implements SearchResultUnionCopyWith<$R, $In, $Out> {
  ...
  SearchResultUnionUnknownCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  );
}

class _SearchResultUnionUnknownCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, SearchResultUnionUnknown, $Out>
    implements
        SearchResultUnionUnknownCopyWith<$R, SearchResultUnionUnknown, $Out> {
  _SearchResultUnionUnknownCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<SearchResultUnionUnknown> $mapper =
      SearchResultUnionUnknownMapper.ensureInitialized();
  @override
  MapCopyWith<$R, String, dynamic, ObjectCopyWith<$R, dynamic, dynamic>>
  ...
  @override
  SearchResultUnionUnknown $make(CopyWithData data) =>
      SearchResultUnionUnknown(data.get(#json, or: $value.json));

  @override
  SearchResultUnionUnknownCopyWith<$R2, SearchResultUnionUnknown, $Out2>
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _SearchResultUnionUnknownCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
