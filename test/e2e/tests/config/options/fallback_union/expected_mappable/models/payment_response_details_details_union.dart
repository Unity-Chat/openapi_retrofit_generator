...
extension PaymentResponseDetailsDetailsUnionDeserializer
  ...
  static PaymentResponseDetailsDetailsUnion tryDeserialize(
    ...
    try {
      return PaymentResponseDetailsDetailsUnionUnknownMapper.fromJson(json);
    } catch (_) {}
...
@MappableClass()
class PaymentResponseDetailsDetailsUnionUnknown
    extends PaymentResponseDetailsDetailsUnion
    with PaymentResponseDetailsDetailsUnionUnknownMappable {
  final Map<String, dynamic> json;

  const PaymentResponseDetailsDetailsUnionUnknown(this.json);
}
