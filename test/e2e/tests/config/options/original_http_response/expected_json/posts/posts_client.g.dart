...
class _PostsClient implements PostsClient {
  ...
  @override
  Future<HttpResponse<ListPostsResponse>> listPosts({Filters? filters}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'filters': filters?.toJson()};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<ListPostsResponse>>(
  ...
  @override
  Future<HttpResponse<PostModel>> createPost({CreatePostRequest? body}) async {
    final _extra = <String, dynamic>{};
  ...
  Future<HttpResponse<GetPostResponse>> getPost({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<GetPostResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/posts/${postId}',
