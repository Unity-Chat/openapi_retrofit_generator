...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Object0&&(identical(other.street, street) || other.street == street));
}
...
class _Object0 implements Object0 {
  const _Object0({required this.street});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Object0&&(identical(other.street, street) || other.street == street));
}
