...
class _CreateUserResponse implements CreateUserResponse {
  const _CreateUserResponse({this.id});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CreateUserResponse&&(identical(other.id, id) || other.id == id));
}
