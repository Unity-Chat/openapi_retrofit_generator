...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ClassWithNullableTypes&&(identical(other.p1, p1) || other.p1 == p1)&&const DeepCollectionEquality().equals(other.p2, p2)&&const DeepCollectionEquality().equals(other.p2NullItem, p2NullItem)&&const DeepCollectionEquality().equals(other.p2NullAll, p2NullAll)&&(identical(other.classWithNullableTypesP3, classWithNullableTypesP3) || other.classWithNullableTypesP3 == classWithNullableTypesP3)&&const DeepCollectionEquality().equals(other.requiredNullAnyOf, requiredNullAnyOf)&&const DeepCollectionEquality().equals(other.p1AnyOf, p1AnyOf)&&const DeepCollectionEquality().equals(other.p2AnyOf, p2AnyOf)&&const DeepCollectionEquality().equals(other.p3AnyOf, p3AnyOf)&&const DeepCollectionEquality().equals(other.p1OneOf, p1OneOf)&&const DeepCollectionEquality().equals(other.p2OneOf, p2OneOf)&&const DeepCollectionEquality().equals(other.p3OneOf, p3OneOf)&&const DeepCollectionEquality().equals(other.p1AllOf, p1AllOf)&&const DeepCollectionEquality().equals(other.p2AllOf, p2AllOf)&&const DeepCollectionEquality().equals(other.p3AllOf, p3AllOf)&&(identical(other.validInt, validInt) || other.validInt == validInt)&&(identical(other.validString, validString) || other.validString == validString)&&const DeepCollectionEquality().equals(other.validArray, validArray)&&const DeepCollectionEquality().equals(other.p2Null, p2Null)&&(identical(other.p1N, p1N) || other.p1N == p1N)&&const DeepCollectionEquality().equals(other.p2N, p2N)&&(identical(other.classWithNullableTypesP3N, classWithNullableTypesP3N) || other.classWithNullableTypesP3N == classWithNullableTypesP3N)&&(identical(other.p1List, p1List) || other.p1List == p1List)&&const DeepCollectionEquality().equals(other.p2List, p2List)&&const DeepCollectionEquality().equals(other.p3List, p3List)&&const DeepCollectionEquality().equals(other.nonNullAnyOf, nonNullAnyOf)&&const DeepCollectionEquality().equals(other.optionalNullAnyOf, optionalNullAnyOf));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,p1,const DeepCollectionEquality().hash(p2),const DeepCollectionEquality().hash(p2NullItem),const DeepCollectionEquality().hash(p2NullAll),classWithNullableTypesP3,const DeepCollectionEquality().hash(requiredNullAnyOf),const DeepCollectionEquality().hash(p1AnyOf),const DeepCollectionEquality().hash(p2AnyOf),const DeepCollectionEquality().hash(p3AnyOf),const DeepCollectionEquality().hash(p1OneOf),const DeepCollectionEquality().hash(p2OneOf),const DeepCollectionEquality().hash(p3OneOf),const DeepCollectionEquality().hash(p1AllOf),const DeepCollectionEquality().hash(p2AllOf),const DeepCollectionEquality().hash(p3AllOf),validInt,validString,const DeepCollectionEquality().hash(validArray),const DeepCollectionEquality().hash(p2Null),p1N,const DeepCollectionEquality().hash(p2N),classWithNullableTypesP3N,p1List,const DeepCollectionEquality().hash(p2List),const DeepCollectionEquality().hash(p3List),const DeepCollectionEquality().hash(nonNullAnyOf),const DeepCollectionEquality().hash(optionalNullAnyOf)]);
...
@useResult
$Res call({
 String p1, List<String> p2,@JsonKey(name: 'p2_null_item') List<List<String?>> p2NullItem,@JsonKey(name: 'p2_null_all') List<dynamic>? p2NullAll,@JsonKey(name: 'ClassWithNullableTypesP3') ClassWithNullableTypesP3 classWithNullableTypesP3,@JsonKey(name: 'required_null_anyOf') dynamic requiredNullAnyOf,@JsonKey(name: 'p1_anyOf') dynamic p1AnyOf,@JsonKey(name: 'p2_anyOf') dynamic p2AnyOf,@JsonKey(name: 'p3_anyOf') dynamic p3AnyOf,@JsonKey(name: 'p1_oneOf') dynamic p1OneOf,@JsonKey(name: 'p2_oneOf') dynamic p2OneOf,@JsonKey(name: 'p3_oneOf') dynamic p3OneOf,@JsonKey(name: 'p1_allOf') dynamic p1AllOf,@JsonKey(name: 'p2_allOf') dynamic p2AllOf,@JsonKey(name: 'p3_allOf') dynamic p3AllOf,@JsonKey(name: 'valid_int') int? validInt,@JsonKey(name: 'valid_string') String? validString,@JsonKey(name: 'valid_array') List<String>? validArray,@JsonKey(name: 'p2_null') List<dynamic>? p2Null,@JsonKey(name: 'p1_n') String? p1N,@JsonKey(name: 'p2_n') List<String?>? p2N,@JsonKey(name: 'ClassWithNullableTypesP3N') ClassWithNullableTypesP3N? classWithNullableTypesP3N,@JsonKey(name: 'p1_list') String? p1List,@JsonKey(name: 'p2_list') List<dynamic>? p2List,@JsonKey(name: 'p3_list') dynamic p3List,@JsonKey(name: 'nonNull_anyOf') dynamic nonNullAnyOf,@JsonKey(name: 'optional_null_anyOf') dynamic optionalNullAnyOf
});
...
as ClassWithNullableTypesP3,requiredNullAnyOf: freezed == requiredNullAnyOf ? _self.requiredNullAnyOf : requiredNullAnyOf // ignore: cast_nullable_to_non_nullable
as dynamic,p1AnyOf: freezed == p1AnyOf ? _self.p1AnyOf : p1AnyOf // ignore: cast_nullable_to_non_nullable
as dynamic,p2AnyOf: freezed == p2AnyOf ? _self.p2AnyOf : p2AnyOf // ignore: cast_nullable_to_non_nullable
as dynamic,p3AnyOf: freezed == p3AnyOf ? _self.p3AnyOf : p3AnyOf // ignore: cast_nullable_to_non_nullable
as dynamic,p1OneOf: freezed == p1OneOf ? _self.p1OneOf : p1OneOf // ignore: cast_nullable_to_non_nullable
as dynamic,p2OneOf: freezed == p2OneOf ? _self.p2OneOf : p2OneOf // ignore: cast_nullable_to_non_nullable
...
as dynamic,optionalNullAnyOf: freezed == optionalNullAnyOf ? _self.optionalNullAnyOf : optionalNullAnyOf // ignore: cast_nullable_to_non_nullable
as dynamic,
  ));
}
/// Create a copy of ClassWithNullableTypes
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String p1,  List<String> p2, @JsonKey(name: 'p2_null_item')  List<List<String?>> p2NullItem, @JsonKey(name: 'p2_null_all')  List<dynamic>? p2NullAll, @JsonKey(name: 'ClassWithNullableTypesP3')  ClassWithNullableTypesP3 classWithNullableTypesP3, @JsonKey(name: 'required_null_anyOf')  dynamic requiredNullAnyOf, @JsonKey(name: 'p1_anyOf')  dynamic p1AnyOf, @JsonKey(name: 'p2_anyOf')  dynamic p2AnyOf, @JsonKey(name: 'p3_anyOf')  dynamic p3AnyOf, @JsonKey(name: 'p1_oneOf')  dynamic p1OneOf, @JsonKey(name: 'p2_oneOf')  dynamic p2OneOf, @JsonKey(name: 'p3_oneOf')  dynamic p3OneOf, @JsonKey(name: 'p1_allOf')  dynamic p1AllOf, @JsonKey(name: 'p2_allOf')  dynamic p2AllOf, @JsonKey(name: 'p3_allOf')  dynamic p3AllOf, @JsonKey(name: 'valid_int')  int? validInt, @JsonKey(name: 'valid_string')  String? validString, @JsonKey(name: 'valid_array')  List<String>? validArray, @JsonKey(name: 'p2_null')  List<dynamic>? p2Null, @JsonKey(name: 'p1_n')  String? p1N, @JsonKey(name: 'p2_n')  List<String?>? p2N, @JsonKey(name: 'ClassWithNullableTypesP3N')  ClassWithNullableTypesP3N? classWithNullableTypesP3N, @JsonKey(name: 'p1_list')  String? p1List, @JsonKey(name: 'p2_list')  List<dynamic>? p2List, @JsonKey(name: 'p3_list')  dynamic p3List, @JsonKey(name: 'nonNull_anyOf')  dynamic nonNullAnyOf, @JsonKey(name: 'optional_null_anyOf')  dynamic optionalNullAnyOf)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ClassWithNullableTypes() when $default != null:
...
@override@JsonKey(name: 'required_null_anyOf') final  dynamic requiredNullAnyOf;
@override@JsonKey(name: 'p1_anyOf') final  dynamic p1AnyOf;
@override@JsonKey(name: 'p2_anyOf') final  dynamic p2AnyOf;
@override@JsonKey(name: 'p3_anyOf') final  dynamic p3AnyOf;
@override@JsonKey(name: 'p1_oneOf') final  dynamic p1OneOf;
...
@override@JsonKey(name: 'nonNull_anyOf') final  dynamic nonNullAnyOf;
@override@JsonKey(name: 'optional_null_anyOf') final  dynamic optionalNullAnyOf;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,p1,const DeepCollectionEquality().hash(_p2),const DeepCollectionEquality().hash(_p2NullItem),const DeepCollectionEquality().hash(_p2NullAll),classWithNullableTypesP3,const DeepCollectionEquality().hash(requiredNullAnyOf),const DeepCollectionEquality().hash(p1AnyOf),const DeepCollectionEquality().hash(p2AnyOf),const DeepCollectionEquality().hash(p3AnyOf),const DeepCollectionEquality().hash(p1OneOf),const DeepCollectionEquality().hash(p2OneOf),const DeepCollectionEquality().hash(p3OneOf),const DeepCollectionEquality().hash(p1AllOf),const DeepCollectionEquality().hash(p2AllOf),const DeepCollectionEquality().hash(p3AllOf),validInt,validString,const DeepCollectionEquality().hash(_validArray),const DeepCollectionEquality().hash(_p2Null),p1N,const DeepCollectionEquality().hash(_p2N),classWithNullableTypesP3N,p1List,const DeepCollectionEquality().hash(_p2List),const DeepCollectionEquality().hash(p3List),const DeepCollectionEquality().hash(nonNullAnyOf),const DeepCollectionEquality().hash(optionalNullAnyOf)]);
