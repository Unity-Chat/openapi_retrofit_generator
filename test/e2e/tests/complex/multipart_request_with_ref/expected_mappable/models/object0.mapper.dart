...
class Object0Mapper extends ClassMapperBase<Object0> {
  ...
  static const Field<Object0, String> _f$street = Field(
    'street',
    _$street,
    opt: true,
  );
  static bool? _$deleted(Object0 v) => v.deleted;
  static const Field<Object0, bool> _f$deleted = Field(
    'deleted',
    _$deleted,
    opt: true,
  );
  ...
  static Object0 _instantiate(DecodingData data) {
    return Object0(street: data.dec(_f$street), deleted: data.dec(_f$deleted));
  }
