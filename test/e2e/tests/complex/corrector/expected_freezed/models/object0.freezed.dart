...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Object0&&(identical(other.test, test) || other.test == test));
}
...
class _Object0 implements Object0 {
  const _Object0({@JsonKey(includeIfNull: false) this.test});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Object0&&(identical(other.test, test) || other.test == test));
}
